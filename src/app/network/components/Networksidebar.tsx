...
const Networksidebar = () => {
  ...
  return (
    <div className="grid md:grid-cols-4 gap-5">
      <div className="md:col-span-1 bg-white dark:bg-zinc-900 md:p-6 p-3  border dark:border-zinc-800/40 rounded-md h-64">
        ...
        <div className="space-y-2.5 mt-2">
          <button
            ...
            className={`text-sm w-full rounded-md cursor-pointer border py-1.5 ${
          ...
          <button
            onClick={() => setActiveSection("sentRequest")}
            className={`text-sm w-full rounded-md  cursor-pointer border py-1.5 ${
              activeSection === "sentRequest"
                ? "bg-green-accent text-white"
                : "hover-bg-green-accent hover:text-white"
            }`}
          >
